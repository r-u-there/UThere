...
from .models import User, ContactForm, Profile, Settings, Meeting, MeetingUser,Presenter, AttentionEmotionScore,ScreenShare, AttentionEmotionScoreAverage, Poll, Options
...
class MeetingUserSerializer(serializers.ModelSerializer):
    class Meta:
        model = MeetingUser
        fields = ['id', 'is_host','access_report', 'is_presenter', 'join_time', 'left_time', 'meeting','user','agora_id','is_removed','alert_num', 'latest_poll']
...
class PollSerializer(serializers.ModelSerializer):
    class Meta:
        model = Poll
        fields = ['id', 'meeting', 'creator','question_body']
...
class OptionsSerializer(serializers.ModelSerializer):
    class Meta:
        model = Options
        fields = ['id', 'poll', 'option_body','count']
